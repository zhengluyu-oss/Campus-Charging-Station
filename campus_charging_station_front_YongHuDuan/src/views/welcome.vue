...
.gradient-background {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(45deg, #ff9a9e, #fad0c4, #fbc2eb, #a6c1ee, #c2e9fb, #a1c4fd);
...
@keyframes titleGlow {
  ...
  100% {
    text-shadow: 0 0 30px rgba(0, 201, 255, 0.6), 0 0 60px rgba(146, 254, 157, 0.4);
  }
}
